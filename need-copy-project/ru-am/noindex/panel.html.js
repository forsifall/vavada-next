  ...
  <div class="games-header-wrapper">
    ...
    <form class="games-header-search" action="/ipc.html" autocomplete="off">
      <div class="games-header-search-input-box">
        <a class="search_submit" href="ipc.html" rel="nofollow, noopener, noreferrer" target="_blank" aria-label="Перейти в VIP раздел">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.33333 12.6667C10.2789 12.6667 12.6667 10.2789 12.6667 7.33333C12.6667 4.38781 10.2789 2 7.33333 2C4.38781 2 2 4.38781 2 7.33333C2 10.2789 4.38781 12.6667 7.33333 12.6667Z" stroke="#8A8AAE" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M14 14L11.1 11.1" stroke="#8A8AAE" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </a>
        <input type="search" name="search" placeholder="Поиск" aria-label="Поиск игр">
      </div>
    </form>
  </div>
</div>
